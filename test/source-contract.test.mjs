...
test('package exposes one LifeSpace credential type', async () => {
  ...
  assert.doesNotMatch(trigger, /lifeSpaceWebhookApi/u);
});

test('Runtime Discovery is cross-Space and Record UX is adapter-facing', async () => {
...
test('Action, Trigger and credential share the same LifeSpace mark', async () => {
